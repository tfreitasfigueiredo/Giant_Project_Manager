  ...
  return (
    <main className="grid min-h-screen bg-slate-950 p-4 text-white lg:grid-cols-[0.9fr_1.1fr] lg:p-0">
      <section className="flex flex-col justify-between rounded-xl bg-white p-6 text-slate-950 lg:rounded-none lg:p-10">
        ...
        <div className="mt-16 flex max-w-xl flex-col gap-4 lg:mt-0"><h1 className="text-4xl font-semibold tracking-normal lg:text-5xl">Gestão executiva de projetos sem planilhas paralelas.</h1><p className="text-base leading-7 text-slate-600">Cockpit executivo, riscos, pendências, tempo e status report em uma única experiência responsiva.</p></div>
        <p className="mt-10 text-sm text-slate-500">Acesso demonstrativo. Autenticação real será conectada futuramente.</p>
      </section>
