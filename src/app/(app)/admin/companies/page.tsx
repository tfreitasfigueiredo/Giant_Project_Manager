...
const rows = [
  { name: "BOGE", role: "Cliente", status: "Ativo" },
  { name: "Grupo Mirassol", role: "Holding", status: "Ativo" },
  { name: "Comercial", role: "Área interna", status: "Ativo" },
];

export default function AdminPage() {
  return (
    <PageContainer title="Administração / Empresas" description="Empresas e clientes disponíveis para a carteira." showPageHeader={false}>
        ...
        <Card className="border-slate-200/80 bg-white shadow-[0_12px_35px_rgba(15,23,42,0.06)]">
          <CardContent className="flex min-h-28 items-center gap-4 p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs font-medium text-slate-500">Cadastro inicial</p>
            </div>
          </CardContent>
        </Card>
        <Card className="border-slate-200/80 bg-white shadow-[0_12px_35px_rgba(15,23,42,0.06)]">
          <CardContent className="flex min-h-28 items-center gap-4 p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-3xl font-bold text-slate-950">{rows.length}</p>
              <p className="mt-1 text-xs font-medium text-slate-500">Disponíveis para projetos</p>
            </div>
          </CardContent>
        </Card>
        <Card className="border-slate-200/80 bg-white shadow-[0_12px_35px_rgba(15,23,42,0.06)]">
          <CardContent className="flex min-h-28 items-center gap-4 p-5">
            <div className="flex size-11 items-center justify-center rounded-full bg-slate-100 text-slate-700 ring-8 ring-slate-50">
              <Network className="size-5" />
            </div>
            <div>
              <p className="text-sm font-medium text-slate-500">Perfis</p>
              <p className="mt-1 text-3xl font-bold text-slate-950">3</p>
              <p className="mt-1 text-xs font-medium text-slate-500">Cliente, holding e área</p>
            </div>
          </CardContent>
        </Card>
      </div>
