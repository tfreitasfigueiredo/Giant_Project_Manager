import { Boxes, CheckCircle2, Factory } from "lucide-react";
...
const rows = [
  { name: "Operações", role: "Unidade", status: "Ativo" },
  { name: "Control Tower", role: "Unidade", status: "Ativo" },
  { name: "Planejamento", role: "Unidade", status: "Ativo" },
];
        ...
        <Card className="border-slate-200/80 bg-white shadow-[0_12px_35px_rgba(15,23,42,0.06)]">
          <CardContent className="flex min-h-28 items-center gap-4 p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs font-medium text-slate-500">Estrutura inicial</p>
            </div>
          </CardContent>
        </Card>
        <Card className="border-slate-200/80 bg-white shadow-[0_12px_35px_rgba(15,23,42,0.06)]">
          <CardContent className="flex min-h-28 items-center gap-4 p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-3xl font-bold text-slate-950">{rows.length}</p>
              <p className="mt-1 text-xs font-medium text-slate-500">Aptas para vínculo</p>
            </div>
          </CardContent>
        </Card>
        <Card className="border-slate-200/80 bg-white shadow-[0_12px_35px_rgba(15,23,42,0.06)]">
          <CardContent className="flex min-h-28 items-center gap-4 p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs font-medium text-slate-500">Unidade operacional</p>
            </div>
          </CardContent>
        </Card>
      </div>
